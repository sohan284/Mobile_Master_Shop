    ...
    <MotionFade delay={0.4} immediate={true}>
      <section className="my-16">
        <div className=" gap-6">
          ...
          <div className="bg-gradient-to-br from-gray-100/40 to-gray-300/40 backdrop-blur-sm rounded-2xl border border-gray-600/20 p-6 md:p-8 grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className={showReviewForm ? 'grid grid-cols-1 md:grid-cols-2 gap-8 col-span-1 mt-8' : 'mt-10'}>
              <div>
                ...
                {/* Overall Rating */}
                <div className={`flex flex-col gap-6 ${showReviewForm ? 'mb-6 pb-6 border-gray-300' : 'mb-0 pb-0'}`}>
                  <div className="flex flex-col items-center md:items-start">
                    ...
                    <div className="text-gray-600 text-xs">{reviews.length} ratings</div>
                  </div>
                    ...
                    {[5, 4, 3, 2, 1].map((rating) => {
                      ...
                      return (
                        <div key={rating} className="flex items-center gap-2">
                          <span className="text-xs font-medium w-6 text-secondary">{rating}.0</span>
              ...
              {showReviewForm && (
                <div className="mb-6 pb-6 border-gray-300">
                  ...
                  <form onSubmit={handleSubmitReview} className="space-y-4">
                    <div>
                      ...
                      <input
                        ...
                        required
                        className="w-full px-4 py-2 bg-white border border-gray-300 rounded-lg text-secondary focus:outline-none focus:border-secondary"
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        required
                        rows={4}
                        className="w-full px-4 py-2 bg-white border border-gray-300 rounded-lg text-secondary focus:outline-none focus:border-secondary resize-none"
                  ...
                  {!showAllReviews ? (
                    <>
                      {reviews.slice(0, 3).map((review, index) => (
                        <div key={review.id || index} className="pb-6 border-b border-gray-300 last:border-b-0">
