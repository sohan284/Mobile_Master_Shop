        ...
        <div className="max-w-md mx-auto">
          <div className="relative">
            <input
              ...
              className="w-full px-4 py-4 pl-12 pr-4 text-accent bg-white/10 backdrop-blur-sm border-2 border-accent/30 rounded-md focus:outline-none focus:border-secondary transition-all duration-300 shadow hover:shadow-lg placeholder:text-accent/60"
            />
