            ...
            <div className="container  mx-auto px-4 lg:px-8">
                ...
                <div className="text-center mb-16">
                    <motion.h1
                        ...
                        className="text-4xl md:text-6xl font-extrabold tracking-wider text-secondary"
                    >
                        {t('fixYourDevice')}
                    </motion.h1>
                    <motion.p
                ...
                >
                    <div className="text-center mb-12">
                        ...
                        <p className="text-gray-600 max-w-2xl mx-auto">{t('professionalRepairs')}</p>
                    </div>
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8">
                        {repairServices.map((service, idx) => (
                            ...
                            >       <div className="bg-gradient-to-br from-gray-300/40 to-gray-500/40 backdrop-blur-sm rounded-md p-2 shadow-lg hover:shadow-xl transition-all duration-500 border border-gray-600/20 hover:border-secondary/50 h-full overflow-hidden">
                                    {/* Popular Badge */}

                                    <div className="text-center h-full flex flex-col">
                                        {/* Service Icon */}
                                        <div className="mb-6 bg-gradient-to-br p-3 from-gray-600/10 to-gray-600/10 rounded-md group-hover:from-secondary/20 group-hover:to-primary/20 transition-all duration-500 relative overflow-hidden">
                                            <Image
                                                width={400}
                                                height={400}
                                                src={service.src}
                                        ...
                                        <div className="flex-grow flex flex-col justify-between">
                                            <div>
                                                ...
                                                <p className="text-gray-600 group-hover:text-secondary transition-colors duration-300 text-sm mb-4">{service.description}</p>
                                            </div>
                ...
                >
                    <div className="text-center mb-12">
                        ...
                        <p className="text-gray-600">{t('weRepairDevices')}</p>
                    </div>
                ...
                >
                    <div className="text-center mb-12">
                        <h3 className="text-3xl font-bold mb-4 text-secondary">{t('whyChooseUs')}</h3>
                            ...
                            return (
                                ...
                                >
                                    <div className="relative bg-gradient-to-br from-gray-300/40 to-gray-500/40 backdrop-blur-sm border border-gray-700/50 rounded-2xl p-6 text-center hover:border-gray-600 transition-all duration-300 hover:shadow-2xl hover:scale-105 h-full flex flex-col">
                                        ...
                                        <h4 className="text-lg font-bold mb-2 text-secondary">{feature.text}</h4>
