...
export default function RepairClient({ initialBrands = [], isLoading: initialLoading = false, error: initialError = null }) {
  ...
  const fallbackBrands = [
    ...
    { id: 3, name: "Huawei", logo: "/Huaomi.png", route: "/repair/huawei" },
  ...
  const phoneBrands = initialBrands.length > 0 ? initialBrands : fallbackBrands;
